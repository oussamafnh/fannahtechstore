            ...
            <div class="row">
                <div class="col-sm-6 text-black">
                    ...
                    <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                        ...
                        <form method="POST" action="{{ route('users.register') }}" style="width: 23rem;">
                            @csrf

                            <h3 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Log in</h3>

                            <div class="form-outline mb-2">
                                <input type="text" name="name" id="form2Example18"
                            ...
                            <div class="form-outline mb-2">
                                <input type="password" name="password_confirmation" id="form2Example28"
                                    class="form-control form-control-lg" required/>
                            ...
                            <p>you have an account? <a href="{{ route('users.showLoginForm') }}" class="link-info">Login here</a></p>
